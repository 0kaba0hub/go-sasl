...
//
// Upstream removed the server in commit b788ff2 (issue
// emersion/go-sasl#19) on the grounds that it is legacy. The Yarilo
// fork restores it verbatim so legacy MUAs (older Outlook, some Android
// clients) keep working against yarilo-submission and yarilo-imap.
